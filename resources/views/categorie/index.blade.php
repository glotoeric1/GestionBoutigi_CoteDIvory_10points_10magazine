...
<div class="card">
    <div class="card-header">
        ...
        <a class="btn btn-outline-primary float-right rounded-pill" href="{{ route("categorie.create") }}"> <i class="fas fa-plus"></i> Ajouter</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <a href="{{route("categorie.index")}}" class="btn btn-outline-success mb-2">Total : {{number_format($total)}}</a>
        <table id="example1" class="table table-bordered table-striped table-hover">
            ...
            @foreach($datas as $data)
             <tr>
                    ...
                    <td>
                        <a href="{{ route("categorie.edit", [$data->id]) }}">
