                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="nom" name="nom" class="form-control @error('nom') is-invalid @enderror"
                                id="exampleInputPassword1" placeholder="Nom">
                            @error('nom')
                        ...
                        <div class="form-group">
                            ...
                            <input type="adresse" name="adresse" class="form-control @error('adresse') is-invalid @enderror"
                                id="exampleInputPassword1" placeholder="Adresse">
                            @error('adresse')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
