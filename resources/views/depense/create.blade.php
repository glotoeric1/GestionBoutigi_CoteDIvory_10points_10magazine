...
<div class="row">
    ...
    <div class="card card-primary">
        ...
        <h3 class="text-center rounded border border-5 border-success py-2">Montant dans la Caisse : {{number_format($total)}} F cfa</h3>
          <div class="row g-3">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input type="text" name="titre" class="form-control @error('titre') is-invalid @enderror" id="titre" placeholder="" >
                @error("titre")
          ...
          <div class="row g-3">
            ...
            <div class="form-group">
              ...
              <textarea name="descs" id="descs" class="form-control @error('descs') is-invalid @enderror" cols="20" rows="3" placeholder="Reparation de voiture 30000; Essence pour les motos 40000;"></textarea>
              @error("descs")
                  <span class="text-danger"> {{$message}}</span>
              @enderror
          </div>
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <input type="date" name="dates" class="form-control @error('dates') is-invalid @enderror" id="dates" placeholder="" >
          @error("dates")
              <span class="text-danger"> {{$message}}</span>
          @enderror
      </div>
    ...
    <div class="col-md-4">
      ...
      <div class="form-group">
        ...
        <input type="text" name="done_by" class="form-control @error('done_by') is-invalid @enderror" id="done_by" placeholder="" >
        @error("done_by")
            <span class="text-danger"> {{$message}}</span>
        @enderror
    </div>
        ...
        <div class="card-footer">
          ...
          <button type="submit" name="valider" value="print" class="btn btn-outline-primary mx-2 rounded-pill px-4">Enregistrer & Impr</button>
