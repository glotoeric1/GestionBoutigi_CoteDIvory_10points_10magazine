...
<div class="row">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Ajout d'une Catégorie</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      ...
      @csrf
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="nom_categorie" name="nom_categorie" class="form-control @error('nom_categorie') is-invalid @enderror" id="nom_categorie" placeholder="" >
            @error("nom_categorie")
