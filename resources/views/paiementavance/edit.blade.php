...
<div class="row">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="{{ route("paiementavances.update", [$data->id]) }}" method="post">
      @csrf
      @method("PUT")
        <div class="card-body">
          <input type="hidden" name="clientId" id="" value="{{$data->clientId}}">
          <input type="hidden" name="types" id="" value="AVANCE_EDIT">
          <div class="row g-3">
          <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <div class="row g-3">
        ...
        <div class="card-footer">
          ...
          <a class="btn btn-outline-warning mx-2 rounded-pill px-4" href="{{ route("paiementavances.index") }}"> Annuler</a>
        </div>
      </form>
    </div>
  </div>
