...
<h4 style="text-align: center">Facture de : Service</h4>
<h4 style="text-align: center">Service : {{$prodName}} <br> Qté : {{$qte}} </h4>
...
<h5 class="text-center">Arrête le present service à la somme de {{$amountInWords}}</h5>
