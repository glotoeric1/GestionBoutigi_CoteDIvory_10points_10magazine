...
<table style="height: 50px; width: 1030px;" border="2">
    <tbody>
        <tr style="height: 25px;">
            <td style="width: 135.633px; height: 25px; padding-left: 15px;">Date Début :</td>
            <td style="width: 460.367px; height: 25px; padding-left: 5px;">{{$dateDebut}} </td>
        </tr>
        <tr style="height: 25px;">
            <td style="width: 210.633px; height: 25px; padding-left: 15px;">Date Fin :</td>
...
<table style="height: 20px; width: 1030px;" border="3">
    <tbody>
        <tr style="height: 2.8px;">
            ...
            <td style="width: 90px; height: 2.8px; padding-left: 22px; font-size:12px;">bénéfice</td>
            <td style="width: 90px; height: 2.8px; padding-left: 22px; font-size:12px;">Effectué par</td>
        </tr>
        @foreach ($carts as $cart)
            <tr style="height: 2.5px;">
                ...
                <td style="width: 100px; height: 2.5px; padding-left: 5px; font-size:12px;">
                    ...
                    @else
                        {{$cart->ShowProdNameDette($cart->id_prod)}}
                    @endif
                </td>
                ...
                <td style="width: 100px; height: 2.5px; padding-left: 2px; font-size:12px;">
                    {{number_format(((int) $cart->prix - (int) $cart->ShowPriceAchat($cart->id_prod)) * (int) $cart->quantite)}}{{$cc}}
                </td>
                <td style="width: 100px; height: 2.5px; padding-left: 2px; font-size:12px;">
                    @if ($operation == "VENTE")
                ...
                @php
                    $totalBenefic += ((int) $cart->prix - (int) $cart->ShowPriceAchat($cart->id_prod)) * (int) $cart->quantite;
...
<table style="width: 1030px; height: 50px;" border="3">
    <tbody>
        ...
        @if($operation == "VENTE")
            <tr>
                <td style="width: 100px; margin-left: 90em; padding-left: 205px; font-size:12px;">Réduction :</td>
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format($totalR)}}{{$cc}}</td>
            </tr>
            <tr>
                <td style="width: 100px; margin-left: 90em; padding-left: 205px; font-size:12px;">Total :</td>
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format($totalM)}}{{$cc}}</td>
            </tr>
            <tr>
                <td style="width: 100px; margin-left: 90em; padding-left: 205px; font-size:12px;">Total Après Réduction :
                </td>
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format($totalM - $totalR)}}{{$cc}}
                </td>
            </tr>
            <tr>
                <td style="width: 100px; margin-left: 90em; padding-left: 205px; font-size:12px;">Total bénéfice :</td>
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format($totalPrix - $totalR)}}{{$cc}}
                </td>
            </tr>
        @else
            <tr>
                <td style="width: 100px; margin-left: 190em; padding-left: 205px; font-size:12px;">Total :</td>
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format($totalM)}}{{$cc}}</td>
            </tr>
            <tr>
                <td style="width: 100px; margin-left: 190em; padding-left: 205px; font-size:12px;">Montant Payé :</td>
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format($totalM - abs($totalR))}} F cfa
                </td>
            </tr>
            <tr>
                <td style="width: 100px; margin-left: 190em; padding-left: 205px; font-size:12px;">Montant Reste à Payer :
                </td>
            ...
            <tr>
                ...
                <td style="width: 227px; font-size:12px; padding-left: 2px;">{{number_format(($totalBenefic))}}{{$cc}}</td>
            </tr>
        @endif
