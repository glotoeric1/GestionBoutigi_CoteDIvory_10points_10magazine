...
<table style="height: 50px; width: 1030px;" border="2">
    <tbody>
        <tr style="height: 25px;">
            ...
            <td style="width: 264.367px; height: 25px; padding-left: 5px;">{{$productName}} </td>
            <td style="width: 185px; height: 25px; padding-left: 5px;">Effectué par : {{$username}} </td>
        </tr>
        <tr style="height: 25px;">
            <td style="width: 210.633px; height: 25px; padding-left: 15px;">Total Qté :</td>
            <td style="width: 264.367px; height: 25px; padding-left: 5px;">
                {{$totalV}}
            </td>
        </tr>
    </tbody>
...
<table style="height: 20px; width: 1030px;" border="3">
    <tbody>
        <tr style="height: 2.8px;">
            <td style="width: 25px; height: 2.8px; padding-left: 30px; font-size:12px;">Nº:</td>
            <td style="width: 150px; height: 2.8px; padding-left: 15px; font-size:12px;">Prix</td>
            <td style="width: 30px; height: 2.8px; padding-left: 30px; font-size:12px;">Qté</td>
            <td style="width: 250px; height: 2.8px; padding-left: 22px; font-size:12px;">Montant </td>
            <td style="width: 103px; height: 2.8px; padding-left: 22px; font-size:12px;">Date </td>
        </tr>
        @foreach ($carts as $cart)
            <tr style="height: 2.5px;">
                <td style="width: 25px; height: 2.5px; padding-left: 3px; font-size:12px;">{{$i++}} </td>
                <td style="width: 150px; height: 2.5px; padding-left: 3px; font-size:12px;">
                    {{number_format($cart->prix)}}{{$cc}}
                </td>
                <td style="width: 30px; height: 2.5px; padding-left: 3px; font-size:12px;">{{$cart->quantite}} </td>
                <td style="width: 250px; height: 2.5px; padding-left: 3px; font-size:12px;">
                    {{number_format($cart->quantite * $cart->prix)}}{{$cc}}
                </td>
                <td style="width: 103px; height: 2.5px; padding-left: 3px; font-size:12px;">
...
<table style="width: 1030px; height: 50px;" border="3">
    <tbody>
        ...
        @if($operation == "VENTE")
            <tr>
                <td style="width: 200px; margin-left: 100em; padding-left: 90px; font-size:12px;">Réduction :</td>
                <td style="width: 269px; font-size:12px; padding-left:2px; padding-right:11em;">
                    {{number_format($totalR)}}{{$cc}}
                </td>
            </tr>
            <tr>
                <td style="width: 200px; margin-left: 100em; padding-left: 90px; font-size:12px;">Total :</td>
                <td style="width: 269px; font-size:12px; padding-left:2px; padding-right:11em;">
                    {{number_format($totalM)}}{{$cc}}
                </td>
            </tr>
            <tr>
                <td style="width: 200px; margin-left: 100em; padding-left: 40px; font-size:12px;">Total Après Réduction :
                </td>
                <td style="width: 269px; font-size:12px; padding-left:2px; padding-right:11em;">
        ...
        @else
            ...
            <tr>
                <td style="width: 200px; margin-left: 100em; padding-left: 90px; font-size:12px;">Montant Payé :</td>
                <td style="width: 269px; font-size:12px; padding-left:2px; padding-right:11em;">
                    {{number_format($totalM - abs($totalR))}}{{$cc}}
                </td>
            </tr>
            <tr>
                <td style="width: 200px; margin-left: 100em; padding-left: 40px; font-size:12px;">Montant Reste à Payer :
                </td>
                <td style="width: 269px; font-size:12px; padding-left:2px; padding-right:11em;">
