...
<table style="height: 20px; width: 1030px;" border="3">
    <tbody>
        <tr style="height: 2.8px;">
            <td style="width: 210.633px; height: 2.8px; padding-left: 15px;">Prix</td>
            <td style="width: 264.367px; height: 2.8px; padding-left: 30px;">Qté</td>
            <td style="width: 130.633px; height: 2.8px; padding-left: 22px;">Montant </td>
        </tr>
        @foreach ($carts as $cart)
            <tr style="height: 2.5px;">
                <td style="width: 210.633px; height: 2.5px; padding-left: 5px;">{{number_format($cart->prix)}}{{$cc}}</td>
                <td style="width: 264.367px; height: 2.5px; padding-left: 5px;">{{$cart->quantite}} </td>
                <td style="width: 160.633px; height: 2.5px; padding-left: 5px;">
