...
<div class="row">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Ajout d'un sous catégorie</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      ...
      <div class="row">
        <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="nom_type" name="nom_type" class="form-control @error('nom_type') is-invalid @enderror" id="nom_type" placeholder="" >
                  @error("nom_type")
